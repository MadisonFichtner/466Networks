...
if __name__ == '__main__':
    ...
    link_layer.add_link(link_4.Link(host_1, 0, router_a, 0))
    link_layer.add_link(link_4.Link(router_a, 1, router_b, 0))
    link_layer.add_link(link_4.Link(router_a, 2, router_c, 0))
    link_layer.add_link(link_4.Link(router_b, 1, router_d, 0))
    link_layer.add_link(link_4.Link(router_c, 1, router_d, 1))
    link_layer.add_link(link_4.Link(router_d, 2, host_2, 0))
    ...
    for obj in object_L:
        if str(type(obj)) == "<class 'network_4.Router'>":
            obj.print_routes()
